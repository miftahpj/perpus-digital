        ...
        <form>
          ...
          <div class="mb-3">
            <select class="form-control form-control-lg form-select rounded-5">
              ...
              <option value="baca">Baca Buku</option> <option value="pinjam">Pinjam Buku</option>
          ...
          <div >
            ...
            <nuxt-link to="../">
              <button type="submit" class="btn btn-dark btn-lg rounded-5 px-5"style="position:center;">KEMBALI</button>
            </nuxt-link>
            </div>
        </form>
      </div>
